...
![image](/images/posts/ssl---bigroc-1764048857760.png)

输入自己的域名（这里演示是 httpsok.xzy ）并且回车  
![image](/images/posts/ssl---bigroc-1764048858205.png)  
此时，会提示检测中，我们需要再到DNS添加一条 CNAME 类型的解析记录。  
![image](/images/posts/ssl---bigroc-1764048858638.png)  
添加成功后，如下图所示。  
![image](/images/posts/ssl---bigroc-1764048859059.png)  
此时，再回到页面控制台，发现域名已经检测通过了。  
![image](/images/posts/ssl---bigroc-1764048859499.png)  
点击【提交申请】，证书进入申请中，等待1分钟左右，即可申请成功。  
![image](/images/posts/ssl---bigroc-1764048859877.png)
...
回到控制台首页，点击按钮复制安装命令。  
![image](/images/posts/ssl---bigroc-1764048860989.png)  
到服务器，粘贴并执行刚刚复制的命令，此时 自动更新SSL证书，并且自动重载nginx。  
![image](/images/posts/ssl---bigroc-1764048861497.png)

## 通过HTTPS访问网站

点击小锁，可以看到证书详情。（提示：网站404是因为没有部署页面文件，部署之后就不会了）  
![image](/images/posts/ssl---bigroc-1764048861873.png)  
下面是谷歌浏览器查看证书方式  
![image](/images/posts/ssl---bigroc-1764048862261.png)
...
> ![image](/images/posts/ssl---bigroc-1764048862627.png)
