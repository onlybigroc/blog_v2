...
slug: 远程桌面连接（出现身份验证错误。要求的函数不支持）这可能由于CredSSP加密Oracle修正。
categories: []
tags: ["Windows", "Oracle", "远程桌面连接", "出现身份验证错误", "要求的函数不支持", "这可能由于CredSSP加密Oracle修正"]
...
![](/images/posts/0b2fade102532b7fe8b88ee5f2597eff.png)
