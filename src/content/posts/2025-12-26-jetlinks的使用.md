...
originUrl: "https://hanta.yuque.com/px7kg1/yfac2l"
---
...
1. 协议管理
   ...
   2. 编写好自己的对接协议后再此页面上传接口
      上传协议包
      Jar 类型
      ![上传协议包jar](/images/posts/2004404787074629632.png)
      Local 类型
      ![Local 类型](/images/posts/2004089680295149568.png)
2. 网络组件
   创建对应的网络组件，为绑定协议做准备
   ![创建对应的网络组件](/images/posts/1985237541959536640.png)
3. 设备接入网关新增

   1. 接入方式 -> 选择 `MQTT直连接入`
   ![新增设备接入网关](/images/posts/2004405187035070464-1.png)
   2. 网络组件 -> 选择 `MQTT网络组件`  
   ![网络组件](/images/posts/2004405187035070464-2.png)
   3. 消息协议 -> 选择 `网关协议`
   ![消息协议](/images/posts/2004405187035070464-3.png)
   4. 填写必要信息，完成设备接入网关新增
...
4. 创建产品
   1. 创建网关产品 - 设备类型选择 `网关设备`
      ![img.png](/images/posts/2004405469022322688-1.png)
   2. 点击卡片 - 选择第3步创建的接入方式 `MQTT 网关接入`
   3. 设置用户名密码
   4. 启用产品
   5. 创建 `网关子设备` 产品，步骤同创建网关产品，设备类型选择 `网关子设备`
      ![img.png](/images/posts/2004405469022322688-2.png)
5. 创建设备 - 选择`所属产品`创建对应的设备即可
   ![img.png](/images/posts/1001001-1.png)
