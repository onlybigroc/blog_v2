...
categories: []
tags: []
summary: "1、获取数组对象中某一值封装为数组（一） data = [[\"2000-06-05\",116],[\"2000-06-06\",129]]; var dateList = data.map(function (item) { return item[0]; }); console.log(dateList); ==&gt;[\"2000-06-05\",\"2000-06-06\"] &nbsp; 2、获取数..."
